...
sidebar: operations
title: "BulkUpdate"
permalink: /operation/sqlserver/bulkupdate
...
{: .note }
> The examples below target SQL Server. For the Oracle-specific arguments (`pseudoTableType`) and examples, see [BulkUpdate (Oracle)](/operation/oracle/bulkupdate).
