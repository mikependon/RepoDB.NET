...
sidebar: operations
title: "BulkInsert"
permalink: /operation/sqlserver/bulkinsert
...
{: .note }
> The examples below target SQL Server. For the Oracle-specific arguments (`identityBehavior`, `pseudoTableType`) and examples, see [BulkInsert (Oracle)](/operation/oracle/bulkinsert).
