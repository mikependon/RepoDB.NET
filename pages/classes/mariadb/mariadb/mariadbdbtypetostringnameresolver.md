...
{: .note }
> This resolver is not currently wired into [MariaDbStatementBuilder](/class/mariadb/mariadb/mariadbstatementbuilder) — it is a standalone utility you can use directly if you need to map a `MariaDbType` to its SQL name.
