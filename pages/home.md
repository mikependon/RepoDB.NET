...
{: .warning }
> We have introduced some [breaking changes](https://github.com/mikependon/RepoDB.Stories/blob/main/contents/release-notes/v1.13.0.md) in the newer version of the library.
