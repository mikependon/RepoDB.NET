...
## RepoDb.Firebird (v0.0.1)

Released: September 8, 2026

First general availability (non-preview) release of the Firebird provider, promoting the preview below to stable `v0.0.1`. No functional changes since the preview — see that entry for the full feature set and known limitations.
