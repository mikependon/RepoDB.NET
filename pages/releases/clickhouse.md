...
- [IClickHouseDbSetting](/interface/clickhouse/iclickhousedbsetting) — extends [IDbSetting](/interface/idbsetting) with an `IsWaitForMutationsEnabled` property, controlling whether waiting for ClickHouse mutations to complete is enabled. Implemented by `ClickHouseDbSetting`.
