...
- [IClickHouseDbSetting](/interface/clickhouse/iclickhousedbsetting) — extends [IDbSetting](/interface/idbsetting) with an `IsInternalMutationsEnabled` property, controlling whether ClickHouse's internal mutations are enabled. Implemented by `ClickHouseDbSetting`.
