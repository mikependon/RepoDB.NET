...
- Added parameter attributes mirroring `MySqlParameter` members, settable per entity property: [SourceColumn](/attribute/mysql/mysql/sourcecolumn), [SourceColumnNullMapping](/attribute/mysql/mysql/sourcecolumnnullmapping), and [SourceVersion](/attribute/mysql/mysql/sourceversion).
