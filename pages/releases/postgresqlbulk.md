...
- Fixed the issues when writing the records into the database via `System.DataTable` object using the [BinaryBulkImport](/operation/postgresql/binaryimport), when an Enum-based property is present.
...
- Introduced the [BinaryImport](/operation/postgresql/binaryimport) operation.
