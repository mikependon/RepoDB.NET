...
## RepoDb.MariaDbConnector (v1.0.0)
...
> This is the `MySqlConnector`-based counterpart to [RepoDb.MariaDb](/release/mariadb), which is built on `MySql.Data` instead — pick whichever underlying driver best fits your project.
